...
SCENARIO( "contiguous_range" ) {

  CHECK( ! std20::ranges::contiguous_range< void > );
  CHECK( std20::ranges::contiguous_range< int[2] > );
  CHECK( std20::ranges::contiguous_range< int(&)[2] > );
  CHECK( std20::ranges::contiguous_range< const int[2] > );
  CHECK( std20::ranges::contiguous_range< const int(&)[2] > );
  ...
  CHECK( ! std20::ranges::contiguous_range< std::set< int > > );
  CHECK( ! std20::ranges::contiguous_range< std::set< Foo > > );

  CHECK( std20::ranges::contiguous_range< std::string > );
  CHECK( std20::ranges::contiguous_range< std::string > );

  CHECK( std20::ranges::contiguous_range< std::string_view > );
  CHECK( std20::ranges::contiguous_range< std::string_view > );

  CHECK( std20::ranges::contiguous_range< std::vector< int > > );
  CHECK( std20::ranges::contiguous_range< std::vector< Foo > > );
} // SCENARIO
